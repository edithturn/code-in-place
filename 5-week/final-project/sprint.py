...
class Player(pygame.sprite.Sprite):
	def __init__(self, pos_x, pos_y):
		...
		self.sprites = []
		self.sprites.append(pygame.image.load('villagers/spr_f_old_idle_anim.png'))
		self.sprites.append(pygame.image.load('villagers/spr_m_old_idle_anim.png'))
		self.sprites.append(pygame.image.load('villagers/spr_village_npc_girl01_idle_anim.png'))
